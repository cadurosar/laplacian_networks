...
class PreActResNet(torch.nn.Module):
    def __init__(self, block, num_classes=10, initial_planes=64, classes=10):
        ...
        self.layer5 = block(self.in_planes*wide, self.in_planes*2*wide, 2)
        self.layer6 = block(self.in_planes*2*wide, self.in_planes*2*wide, 1)
        self.layer7 = block(self.in_planes*2*wide, self.in_planes*2*wide, 1)
        self.layer8 = block(self.in_planes*2*wide, self.in_planes*2*wide, 1)

        self.layer9 = block(self.in_planes*2*wide, self.in_planes*4*wide, 2)
        self.layer10 = block(self.in_planes*4*wide, self.in_planes*4*wide, 1)
        self.layer11 = block(self.in_planes*4*wide, self.in_planes*4*wide, 1)
        self.layer12 = block(self.in_planes*4*wide, self.in_planes*4*wide, 1)

        self.layers = [self.layer1, self.layer2, self.layer3, self.layer4,
                       self.layer5, self.layer6, self.layer7, self.layer8,
                       self.layer9, self.layer10, self.layer11, self.layer12]

        self.linear = torch.nn.Linear(self.in_planes*4*wide, self.classes)
...
def PreActResNet18(initial_planes=16, classes=100):
    return PreActResNet(
        PreActBlock, initial_planes=initial_planes, classes=classes)


def PreActResNet18Parseval(initial_planes=16, classes=100):
    return PreActResNet(
